...
* - Controlar asignación de recursos y ejecución de presupuesto.
**************************************************************/
...
function OBR_GUARDAR_OBRA(datos) {
...
function OBR_OBTENER_SIGUIENTE_ID() {
  ...
  if (ultimaFila < 2) {
    return OBR_CONFIG.PREFIJO_ID + "-000001";
  }
