...
* - Inicializar los roles predefinidos en la tabla USR_ROLES.
* 
* RESTICCIONES:
* - No elimina hojas existentes que contengan datos para evitar pérdidas.
...
function INSTALAR_ERP_OPERATIVO() {
  ...
  INST_MODULOS.forEach(function(modulo) {
    ...
    Object.entries(modulo.hojas).forEach(function([nombreHoja, encabezados]) {
      ...
      // Vaciar contenidos respetando tablas nativas
      hoja.clearContents();
  ...
  SpreadsheetApp.getUi().alert(
    ...
    "Se completó la inicialización física del Libro 1 con éxito.\n\n" +
    "✓ 60 Hojas de datos operacionales creadas.\n" +
    "✓ Estructura de Seguridad USR_ instalada.\n" +
    "✓ Colores corporativos aplicados a pestañas.\n" +
    "✓ Roles de sistema por defecto inicializados.\n\n" +
    "Próximo paso: Ejecute 'ACTUALIZAR_MENU' para crear enlaces de navegación.",
